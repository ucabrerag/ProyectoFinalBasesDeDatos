				...
				<table class="table table-bordered" style = "text-align: center; margin-left:350px">
					<thead>
						<tr class="table-secondary">
							...
							<th> MES </th>
							<th> TOTAL DE ESCALERAS DAÑADAS </th>
							<th> TOTAL DE CANASTOS DAÑADOS </th>
...
{   
    ...
    break;
						...
						$query = 
						"SELECT sum(canastos_danados) as totalcanastos, sum(escaleras_danadas) as totalescaleras
                        from cuadrilla WHERE monthname(fecha_salida) = '$mes'";
